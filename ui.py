...
class JarvisUI(QWidget):
    ...
    def init_ui(self):
        ...
        self.add_gif_to_label(self.mic_label,
                              r"/Users/harshitgupta/I3/cbe227_fb70e39e9dd94e30bbe30c48b2367dd8~mv2.gif",
                              size=(720, 220), alignment=Qt.AlignCenter)  
    ...
    def run_main_file(self):
        try:
            ...
            path_to_main_py = os.path.join(current_directory, r"/Users/harshitgupta/I3/voice.py")
